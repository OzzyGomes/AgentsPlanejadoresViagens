...
class CalculatorTools():
    ...
    def calculate(operation):
        """Útil para realizar quaisquer cálculos matemáticos,
            como soma, menos, multiplicação, divisão, etc.
            A entrada para esta ferramenta deve ser um cálculo matemático
            expressão, alguns exemplos são `200*7` ou `5000/2*10`
        """
        try:
